      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 lg:gap-6">
          {steps.map((step, index) => (
            <div key={index} className="animate-fade-in-up" style={{ animationDelay: `${0.2 + index * 0.1}s` }}>
              ...
              <div className="bg-white rounded-2xl sm:rounded-3xl p-6 sm:p-8 h-full flex flex-col items-center text-center shadow-lg border border-white/50 hover:scale-105 transition-transform duration-300">
                {/* Step Number */}
        ...
        <div className="text-center mt-12 sm:mt-16 lg:mt-20 animate-fade-in-up" style={{ animationDelay: '0.8s' }}>
          <div className="inline-flex flex-col sm:flex-row gap-3 sm:gap-4 px-4">
            <Button size="lg" className="bg-[#ebc66d] hover:bg-[#ebc66d]/90 text-black font-semibold px-6 sm:px-8 py-3 sm:py-4 text-sm sm:text-base rounded-xl shadow-lg hover:shadow-xl transition-all hover:scale-105">
              Schedule Pickup Now
            </Button>
            <Button size="lg" variant="outline" className="border-2 border-[#ebc66d] text-black hover:bg-[#ebc66d] hover:text-black transition-all font-semibold px-6 sm:px-8 py-3 sm:py-4 text-sm sm:text-base rounded-xl backdrop-blur-sm">
              Call (404) 555-1234
            </Button>
          </div>
        </div>
