                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <Button
                      variant="outline"
                      size="sm"
                      className="text-black border-[#ebc66d] hover:bg-[#ebc66d] hover:text-black bg-transparent"
                      onClick={() =>
                        window.open(
                          "https://maps.google.com/?q=1295+Brocket+Road,+Suite+A,+Clarkston,+GA+30021",
                          "_blank",
                        )
                      }
                    >
              ...
              <Card className="p-6">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <Badge className={`${isOpen ? "bg-green-100 text-green-800 border-green-200" : "bg-red-100 text-red-800 border-red-200"}`}>
                      <CheckCircleIcon className="w-3 h-3 mr-1" />
                      {isOpen ? "Open Now : 7am - 12am" : "Closed Now : 12am - 7am"}
                    </Badge>
                  </div>
                </div>
              </Card>
